...
import kaans.com.app.dto.UserDto;
import kaans.com.app.exceptions.BadRequestException;
import kaans.com.app.repository.UserRepository;
import kaans.com.app.response.Response;
import kaans.com.app.response.ResponseHandler;
...
import static kaans.com.app.util.Utils.validPassword;
...
@Service
public class AuthService implements IAuthenticateUser, UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        authorities.add(new SimpleGrantedAuthority(userDto.get().getRol().name()));
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            try {
                ...
                String access_token = JWT.create()
                        ...
                        .withClaim("roles", Collections.singletonList(user.getRol()))
                        .sign(algorithm);
